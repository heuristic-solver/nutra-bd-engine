...
5. **LinkedIn Headcount Growth Percentage**: Tracks exact employee payroll headcount and calculates historical growth percentage deltas via Apify.
6. **Nutraceutical Knowledge Base**: Pre-seeded database of **1,022 verified nutraceutical companies** across Finished Brands, CDMOs, Raw Ingredient Suppliers, and Testing CROs.
...
APIFY_API_TOKEN=your_apify_token_optional
```
...
- **Headcount Growth Calculator**: `GET http://127.0.0.1:8000/api/v1/bd/growth?company_name=Herbalife&current_headcount=10200&previous_headcount=9500`
...
| **Headcount Growth Rate (%)** | Apify | $\frac{\text{Current Headcount} - \text{Previous Headcount}}{\text{Previous Headcount}} \times 100$ |
