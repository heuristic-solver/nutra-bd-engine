"""
test_5_companies.py -- Fast 5-company end-to-end test on 5 new nutraceutical companies from KB:
  1. Biohm Technologies (Microbiome Supplements & Biotech)
  2. Gencor Pacific (Branded Bioactive Ingredients)
  3. Horphag Research (Pycnogenol Natural Extracts & Science)
  4. Solis Labs (Nutraceutical CDMO & Private Label)
  5. Rocktomic Labs (Supplement Manufacturer & Fulfillment)
"""
...
COMPANIES = [
    {"name": "Biohm Technologies", "domain": "biohmhealth.com",   "linkedin": "biohm-health"},
    {"name": "Gencor Pacific",     "domain": "gencorpacific.com", "linkedin": "gencor-pacific"},
    {"name": "Horphag Research",   "domain": "horphag.com",       "linkedin": "horphag-research"},
    {"name": "Solis Labs",         "domain": "solislabs.com",     "linkedin": "solis-labs"},
    {"name": "Rocktomic Labs",     "domain": "rocktomic.com",     "linkedin": "rocktomic"},
]

OUT_FILE = "bd_intelligence_test_5co.csv"
SEP = "=" * 80
TIMEOUT = 120
...
def main():
    print(SEP)
    print("  BD INTELLIGENCE TEST RUN -- 5 NEW COMPANIES FROM KB")
    ...
    for i, company in enumerate(COMPANIES, 1):
        ...
        print("    CB Funding: " + str(row["total_funding"]) + " | Last Round: " + str(row["cb_last_funding_type"]) + " | Acquisitions: " + str(row["cb_num_acquisitions"]))
        print("    Exec Moves: " + str(row["exec_arrivals_count"]) + " arrivals, " + str(row["exec_departures_count"]) + " departures | FDA Facilities: " + str(row["fda_registered_facilities"]))
